...
(function( $, window, document, undefined ) {
  $.fn.parallaxElement = function(options) {
    ...
    /*!
     * requestAnimationFrame Polyfill via Paul Irish
    ...
    var defaults = {
      ...
      defaultSpeed:   0.5,      // Default speed if `data-speed` is not present
      ...
      minWidth:       false     // Minumum width that function plugin shoul fire
